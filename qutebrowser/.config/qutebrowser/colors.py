...
# Modified by Renan Guilherme <japareaggae@gmail.com>
...
c.colors.downloads.start.bg = base05
...
c.colors.statusbar.caret.bg = base01
c.colors.statusbar.caret.fg = base0E
c.colors.statusbar.caret.selection.bg = base01
c.colors.statusbar.caret.selection.fg = base0E
c.colors.statusbar.insert.bg = base01
c.colors.statusbar.insert.fg = base0B
c.colors.statusbar.passthrough.bg = base01
c.colors.statusbar.passthrough.fg = base0D
